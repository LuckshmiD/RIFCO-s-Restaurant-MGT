...
namespace Cashier
{
    public partial class TakeawayPayment : Form
    {
        ...
        public TakeawayPayment()
        {
            ...
            MySqlDataReader reader = db.getData("select * from orderlist11");
            tbl.Load(reader);
        ...
        {
            MySqlDataReader reader = db.getData("Select SUM(quantity * price) as price from orderlist11");
            reader.Read();
